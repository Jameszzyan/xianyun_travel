      ...
      <div class="air-sale">
        <el-row type="flex" justify="space-between" class="air-sale-pic">
          <el-col :span="6" v-for="(item,index) in sales" :key="index">
            <nuxt-link
              :to="`/planeTicket/flights?departCity=${item.departCity}&departCode=${item.departCode}&destCity=${item.destCity}&destCode=${item.destCode}&departDate=${item.departDate}`"
            >
...
<script>
import ticketForm from "@/components/planeTicket/ticketForm";
